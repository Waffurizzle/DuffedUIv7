...
C["datatext"] = {
	...
	["gold"] = 6,                                       		-- show your current gold on panels
		["gold_a"] = true,										-- enable archaeology display
		["gold_c"] = true,										-- enable cooking display
		["gold_jc"] = true,										-- enable jewelcrafting display
		["gold_dr"] = true,										-- enable dungeon & raids display
		["gold_pvp"] = true,									-- enable pvp display
		["gold_misc"] = true,									-- enable misc display
